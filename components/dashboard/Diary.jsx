                                ...
                                <div className='relative flex flex-col min-w-[fit-content] '>
                                    ...
                                    <div className={`absolute top-0 mt-[45px] overflow-y-scroll min-w-[fit-content] h-[150px]  z-10 border-[1px] border-[#B6B6B6] rounded-[5px] no-scrollbar opacity-100 transition-opacity duration-300 ease-in-out ${colorInputStatut ? 'opacity-100 visible' : 'opacity-0 invisible'}`}>
                                        <ul className='flex flex-col gap-[5px] justify-center item bg-white'>
                                            ...
                                            <li className='hover:bg-[#dddddd] w-full py-[7px] px-[10px] flex justify-center cursor-pointer' onClick={() => { setColor("#197292"); setColorInputStatut(!colorInputStatut); }}><div className='w-[25px] h-[25px] rounded-full bg-[#197292]'></div></li>
                                            ...
                                            <li className='hover:bg-[#dddddd] w-full py-[7px] px-[10px] flex justify-center cursor-pointer' onClick={() => { setColor("#CD1C18"); setColorInputStatut(!colorInputStatut); }}><div className='w-[25px] h-[25px] rounded-full bg-[#CD1C18]'></div></li>
                                        </ul>
                                    </div>
                                </div>
